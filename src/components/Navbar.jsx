...
import { Network, Menu, X, Sparkles, Moon, Sun, UserCheck, Search } from 'lucide-react';
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              {currentUser ? (
                ...
                <button
                  ...
                  className="text-sm font-medium text-slate-600 hover:text-slate-900 px-2 py-2 cursor-pointer"
                >
                  Sign In
                </button>
              )}
