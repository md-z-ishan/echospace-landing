...
import { BookOpen, Lightbulb, MessageSquare, Brain, Sparkles, Network, Compass, Zap, Search, Filter } from 'lucide-react';
...
export const Sidebar = ({
  ...
  return (
    <div className="w-full lg:w-80 bg-slate-50 border-b lg:border-b-0 lg:border-r border-slate-200 p-4 flex flex-col gap-4 select-none">
      ...
      {/* Node Items List */}
      <div className="flex-1 overflow-y-auto max-h-[320px] lg:max-h-[500px] space-y-2 pr-1">
        {nodes.length === 0 ? (
          <div className="text-center py-8 text-xs text-slate-400">
            No memories or ideas match filter.
          </div>
        ) : (
          nodes.map((node) => {
